...
import org.codehaus.griffon.runtime.hessian.monitor.BurlapClientMonitor;
...
public class DefaultBurlapClientFactory implements BurlapClientFactory {
    ...
    public void destroy(@Nonnull BurlapClient client) {
        ...
        if (client instanceof JMXAwareBurlapClient) {
            unregisterMBeans((JMXAwareBurlapClient) client);
        }
    }

    private void unregisterMBeans(@Nonnull JMXAwareBurlapClient client) {
