...
----
dependencies {
    griffon '{project-group}:griffon-hessian-plugin:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-hessian-core:{project-version}'
}
----
...
----
dependencies {
    compileOnly '{project-group}:griffon-hessian-groovy-compile:{project-version}'
}
----

== Maven

First configure the `griffon-hessian-plugin` BOM in your POM file, by placing the following
