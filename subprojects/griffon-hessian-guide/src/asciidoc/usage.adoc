...
----
include::{path_griffon_hessian_core}/src/main/java/griffon/plugins/hessian/HessianClientCallback.java[lines=27..-1]
----

[source,java,options="nowrap"]
.griffon.plugins.hessian.BurlapClientCallback.java
----
include::{path_griffon_hessian_core}/src/main/java/griffon/plugins/hessian/BurlapClientCallback.java[lines=27..-1]
----
